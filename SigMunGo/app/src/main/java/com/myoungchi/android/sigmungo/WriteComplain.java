...
public class WriteComplain extends AppCompatActivity {
    ...
    private String[][] secondKeywords = {
            {"간이", "온도가", "위생상태가 좋지 않아요(이물질 발견)", "종류가", "양이", "가격", "신선도가 떨어져요", "향이", "식감이", "맛이"},
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("contentId", sharedPreferences.getString("ContentId", ""));
        ...
        wcFirstAdapter = new WCFirstAdapter(firstKeywords, secondKeywords, thirdKeywords, this, secondKeyword, thirdKeyword, sharedPreferences.getString("ContentId", ""));
