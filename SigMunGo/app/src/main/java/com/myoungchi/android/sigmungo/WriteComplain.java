...
public class WriteComplain extends AppCompatActivity {
    ...
    private String[] firstKeywords = {"음식의", "음식점의", "직원의"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        wcFirstAdapter = new WCFirstAdapter(firstKeywords, secondKeywords, thirdKeywords, getApplicationContext(), secondKeyword, thirdKeyword);
