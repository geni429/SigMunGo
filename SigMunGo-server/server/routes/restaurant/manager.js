...
module.exports = {
    addSympathy: function (contentId, id, callback) {
        let response = {
            success: false
        }
    ...
    getMostOfRestaurant: function (callback) {
        let response = {
            0: {
                img: null,
                name: null,
    ...
    getContentId: function (callback) {
        let response = {
            contentId: [],
            name: []
        };
    ...
    addRestaurant: function (contentId, name, place, phone, img, callback) {
        let response = {
            success: false
        };
    ...
    getDetailRestaurant: function (contentId, callback) {
        let response = {
            name: null,
            place: null,
            phone: null,
    ...
    updateRestaurant: function (contentId, name, place, phone, menu, callback) {

    },

    deleteRestaurant: function (contentId, callback) {
        let response = {
            success: false
        };
    ...
    addMenu: function (contentId, menu, callback) {
        let response = {
            success: false
        };
    ...
    getMenu: function (contentId, callback) {
        let response = {
            menu: []
        };
    ...
    deleteMenu: function (contentId, menu) {
        let response = {
            success: false
        };
    ...
    getCountOfPost: function(contentId, callback) {

    },

    updatePost: function(callback) {

    },

    deletePost: function(contentId, callback) {
